...
TEST(TestModern, DigitSeperator) {
#if 201402L <= __cplusplus // C++14~        
    // C++14 숫자 구분자
    {
        int val = 1000000;
...
TEST(TestModern, HexFloatingPointLiteral) {
